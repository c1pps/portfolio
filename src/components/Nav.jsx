export default function Nav() {
    return (
        <>
            <header className='mt-10 mx-[20px] md:mx-[160px] text-white text-xl font-light'>
                <nav>
                    <ul className='flex justify-between'>
                        <div>
                            <li>
                                <a href="" className="relative inline-flex items-center gap-2 font-semibold text-xl md:text-3xl after:absolute after:left-0 after:-bottom-1 after:h-[1px] after:w-4 after:bg-current after:transition-all after:duration-300 hover:after:w-12">wthejulio</a>                            
                            </li>
                        </div>
